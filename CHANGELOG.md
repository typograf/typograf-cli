...
## v6.2.1
- Фикс js-ошибки получения конфига после перехода на ESM-модули @Corvus278

## v6.2.0
- Из зависимостей удалён пакет `isutf8` в пользу `TextDecoder`.
- Данный пакет переведён на ESM-модули.
